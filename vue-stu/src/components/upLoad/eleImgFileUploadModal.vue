      ...
      <el-dialog
       ...
       <el-upload
         ...
         >
          ...
          <el-button class="submit" style="margin-left: 10px;" size="small" type="success" @click="submitUpload">确定上传{{shows}}</el-button>
          <div slot="tip" class="el-upload__tip" v-if="config.tips">{{config.tips}}</div>
        </el-upload>
    </el-dialog>
</template>
<script>
