  ...
  initValue = (value) => {
    if (value) {
      ...
      if (this.props.config.searchService) {
        ...
        if (this.props.showWithFrozen) {
          searchParam['Q_EQ_frozen_bool'] = null;
          searchParam['showWithFrozen'] = true
        }
        if (this.props.showBack) {
          searchParam['showBack'] = true
        }
    ...
    return (
      ...
      >
        <Input placeholder={this.props.placeholder} disabled={this.props.disabled} onFocus={this.showDrop}
          ...
          value={newval ? newval : this.state.textValue} ref={(ref) => this.searchInput = ref}
